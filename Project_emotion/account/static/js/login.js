...
// const myKeyboard_1 = new Keyboard({
//   onChange: input => onChange_2(input),
//   onKeyPress: button => onKeyPress(button)
// });
// // const myKeyboard_2 = new Keyboard({
// //   onChange: input => onChange_2(input),
// //   onKeyPress: button => onKeyPress(button)
// // });

// function onChange_1(input) {
//   document.activeElement.value = input;
//   console.log("Input changed", input);
// }
// function onChange_2(input) {
//   if (document.activeElement == document.querySelector("#password"))
...
// //   document.getElementById('Fst-keyboard').style.display='contents';
// //   // document.getElementById('Snd-keyboard').style.display='none';
// // }
// // // document.getElementById('id').onblur = function(e){
// // document.getElementById('password').onfocus = function(e){
// //   document.getElementById('Fst-keyboard').style.display='contents';
// //   // document.getElementById('Snd-keyboard').style.display='contents';
// // }
